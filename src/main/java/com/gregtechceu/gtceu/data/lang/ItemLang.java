...
public class ItemLang {
    ...
    private static void initItemTooltips(RegistrateLangProvider provider) {
        ...
        multilineLang(provider, "item.gtceu.wetware_processor.tooltip", "§7Ultimate fusion of Flesh and Machine\n§4LuV-Tier Circuit");
        multilineLang(provider, "item.gtceu.wetware_processor_assembly.tooltip", "§7Ultimate fusion of Flesh and Machine\n§4ZPM-tier Circuit");
        multilineLang(provider, "item.gtceu.wetware_processor_computer.tooltip", "§7Ultimate fusion of Flesh and Machine\n§4UV-Tier Circuit");
        multilineLang(provider, "item.gtceu.wetware_processor_mainframe.tooltip", "§7Ultimate fusion of Flesh and Machine\n§4UHV-Tier Circuit");
        multilineLang(provider, "item.gtceu.bio_processor.tooltip",           "§7Integrated Living\n§9ZPM-Tier Circuit");
        multilineLang(provider, "item.gtceu.bio_processor_assembly.tooltip",  "§7Integrated Living\n§9UV-Tier Circuit");
        multilineLang(provider, "item.gtceu.bio_processor_computer.tooltip",  "§7Integrated Living\n§9UHV-Tier Circuit");
        multilineLang(provider, "item.gtceu.bio_processor_mainframe.tooltip", "§7Integrated Living\n§9UEV-Tier Circuit");
        multilineLang(provider, "item.gtceu.optical_processor.tooltip",          "§7An Endless Journey of Lights\n§9UV-Tier Circuit");
        multilineLang(provider, "item.gtceu.optical_processor_assembly.tooltip", "§7An Endless Journey of Lights\n§9UHV-Tier Circuit");
        multilineLang(provider, "item.gtceu.optical_processor_computer.tooltip", "§7An Endless Journey of Lights\n§9UEV-Tier Circuit");
        multilineLang(provider, "item.gtceu.optical_processor_mainframe.tooltip","§7An Endless Journey of Lights\n§9UIV-Tier Circuit");
        multilineLang(provider, "item.gtceu.exotic_processor.tooltip",           "§7Paradigm Shift\n§9UHV-Tier Circuit");
        multilineLang(provider, "item.gtceu.exotic_processor_assembly.tooltip",  "§7Paradigm Shift\n§9UEV-Tier Circuit");
        multilineLang(provider, "item.gtceu.exotic_processor_computer.tooltip",  "§7Paradigm Shift\n§9UIV-Tier Circuit");
        multilineLang(provider, "item.gtceu.exotic_processor_mainframe.tooltip", "§7Paradigm Shift\n§9UXV-Tier Circuit");
        multilineLang(provider, "item.gtceu.cosmic_processor.tooltip",           "§7Trapped in the Cosmic Freeze...\n§9UEV-Tier Circuit");
        multilineLang(provider, "item.gtceu.cosmic_processor_assembly.tooltip",  "§7Trapped in the Cosmic Freeze...\n§9UIV-Tier Circuit");
        multilineLang(provider, "item.gtceu.cosmic_processor_computer.tooltip",  "§7Trapped in the Cosmic Freeze...\n§9UXV-Tier Circuit");
        multilineLang(provider, "item.gtceu.cosmic_processor_mainframe.tooltip", "§7Trapped in the Cosmic Freeze...\n§9OpV-Tier Circuit");
        multilineLang(provider, "item.gtceu.transcendent_processor.tooltip",           "§7Finally, you are here.\n§9UIV-Tier Circuit");
        multilineLang(provider, "item.gtceu.transcendent_processor_assembly.tooltip",  "§7The journey will eventually come to an end.\n§9UXV-Tier Circuit");
        multilineLang(provider, "item.gtceu.transcendent_processor_computer.tooltip",  "§7Everything might be worthless.\n§9OpV-Tier Circuit");
        multilineLang(provider, "item.gtceu.transcendent_processor_mainframe.tooltip", "§7The door to heaven has never been closer...\n§9MAX-Tier Circuit");
