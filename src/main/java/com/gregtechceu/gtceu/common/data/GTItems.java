...
public class GTItems {
    ...
    public static ItemEntry<Item> OPTICALLY_BOULE= REGISTRATE.item("optical_boule", Item::new).lang("Optically Enriched Crystalline Boule").onRegister(compassNodeExist(GTCompassSections.CIRCUITS, "silicon_boule")).register();
